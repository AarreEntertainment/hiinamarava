...
const CACHE_NAME = "HiinaMarava-cache";
const OFFLINE_URL = "HiinaMarava.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["HiinaMarava.html","HiinaMarava.js","HiinaMarava.wasm","HiinaMarava.pck","HiinaMarava.offline.html","HiinaMarava.icon.png","HiinaMarava.apple-touch-icon.png"];
